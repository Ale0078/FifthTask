...
namespace FifthTask.Controllers
{
    public class NumberController : Controller
    {
        ...
        private IExpression CreateExpression(int digitCapacity, IExpression[] numbersToExpression) => digitCapacity switch
        {
            ...
            4 => new ElasticNumberExpression(numbersToExpression[0], "thousand",
                    nonterminalExpression: new HundredNumbersExpression(numbersToExpression[1],
            ...
            5 => new ElasticNumberExpression(numbersToExpression[0], "million",
                    nonterminalExpression: new ElasticNumberExpression(numbersToExpression[1], "thousand",
                    nonterminalExpression: new HundredNumbersExpression(numbersToExpression[2],
